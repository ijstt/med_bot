...
После запуска в телеграме будет работать бот с юзернеймом - https://t.me/medicinskibot.
Для загрузки фотографии - необходимо отправить сжатый файл (формата png/jpg)
